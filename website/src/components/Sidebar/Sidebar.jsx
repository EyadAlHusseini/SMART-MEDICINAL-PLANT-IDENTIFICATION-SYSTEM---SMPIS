...
function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-900 flex flex-col border-r border-slate-200 dark:border-white/10 h-screen sticky top-0 shrink-0 transition-colors duration-300">
      ...
      <div className="mt-auto p-5 border-t border-slate-50 dark:border-white/5">
        <p className="text-[11px] text-slate-400 dark:text-slate-500 uppercase tracking-widest font-semibold mb-1">
          Version 2.4.1
        </p>
