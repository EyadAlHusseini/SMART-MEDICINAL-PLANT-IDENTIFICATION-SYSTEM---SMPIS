  ...
  return (
    <aside className="w-64 bg-white flex flex-col border-r border-slate-200 h-screen sticky top-0 shrink-0">
      ...
      <nav className="flex flex-col p-3 gap-1 mt-4">
        {NAV_ITEMS.map((item) => {
          // ROLE-BASED FILTER: If item is adminOnly and user is not Administrator, skip it.
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) => `
                ...
                ${isActive ? "bg-brand-green text-white shadow-lg shadow-brand-green/20" : "text-slate-600 hover:bg-slate-100"}
              `}
            >
              {({ isActive }) => (
                <>
